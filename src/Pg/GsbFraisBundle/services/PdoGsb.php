 ...
 */
        ...
        public function saisirVehicule($numImmat,$marque,$model,$couleur){
            $req = 'INSERT INTO vehicule(`numImmat`, `marque`, `model`, `couleur`) VALUES ("'.$numImmat.'","'.$marque.'","'.$model.'","'.$couleur.'")';
            $stmt = PdoGsb::$monPdo->prepare($req);
            $stmt->execute();
            $lesLignes = $stmt->fetchAll();
            return $lesLignes;
